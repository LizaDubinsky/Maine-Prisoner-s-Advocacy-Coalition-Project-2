...
p <- ggplot(
  ...
  geom_line() +
  labs(x = "Year", y = "Percent Filled", title = "Percentage of Jails Filled in Maine") +
  theme(legend.position = "top") +
  scale_color_viridis_d()
